...
## Suggested follow-ups I can provide

- A CONTRIBUTING.md with coding conventions and test instructions.
- An ASCII runtime data-flow diagram showing entity -> storages -> zipper -> systems.
- A small CI job snippet to build and run the demo on a headless runner.
